...
```{r}
average_percentage_of_cells_within_radius(formatted_image, reference_phenotypes = "T", target_phenotypes = c("T_cyto", "T_helper"), radius=100, 
column="Cell.Type")
```
...
#Error in `[.data.frame`(sce_data, , c("Cell.X.Position", "Cell.Y.Position",  : 
