...
knitr::opts_chunk$set(
  ...
  comment = "#>",
  crop = NULL,
  echo = TRUE, fig.width = 3.5, fig.height = 3.5, dpi = 30, out.width = "40%")
```
...
```{r, echo=FALSE, fig.height=4, fig.width=2.5, fig.align='centre', out.width = "75%"}
...
```{r, fig.height=1.8, fig.width =4, out.width="100%"}
...
```{r,, fig.width = 2, fig.height=5, out.width = "75%"}
predicted_image2 <- 
...
```{r, fig.width = 3.5, fig.height=2.8, pdi = 72, out.width = "80%"}
# TSNE plot
g <- dimensionality_reduction_plot(predicted_image2, plot_type = "TSNE", feature_colname = "Cell.Type")
...
```{r, fig.width = 2, fig.height = 5, dpi = 50, out.width="90%"}
...
```{r, fig.width = 3, fig.height = 3.2,out.width = "75%"}
