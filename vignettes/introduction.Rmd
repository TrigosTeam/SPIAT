...
We can visualise the spatial distribution of the cell types in the image with `plot_cell_basic`.
...
plot_cell_categories(formatted_image, cell_types_of_interest, colour_vector)
```
