...
#where the count assay stores the expression level of every marker (rows) for every cell (columns), and cell phenotype, x and y coordinates are stored under colData
...
Select the phenotypes in the image.
...
# Marker intensities within radii
