...
```{r}
#clusters <- identify_cell_clusters(formatted_image, cell_types_of_interest = c("CD3,CD4", "CD3,CD8"), radius = 100)
```
...
#plot_composition_heatmap(composition=communities_vis, column_to_consider="Community")
```
