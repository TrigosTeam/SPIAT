...
#' 
calculate_cross_k_multiple_images <- function(image_point_patterns, phenotype_group1, phenotype_group2, names = NULL, plot = 1){
  ...
  for(val in i){
    cross_k_function[[val]] <- calculate_k_cross_function(image_point_patterns[[val]], phenotype_group1, phenotype_group2, plot = plot)
  }
