...
#'
#' @export
#' @param format - a string: either "INFORM" or "HALO"
#' @param image - a string of the location of either HALO csv file or INFORM textfile
#' @param markers - a vector containing the markers used for staining
#' @param dye_columns_interest - only for HALO formats, it is a vector of length equal to
#' markers which contains the column names for marker expression status, either 0
#' for no expression or 1 for expression. it must be in the same order as the markers
#' @param intensity_columns_interest - a vector of length equal to the markers which
