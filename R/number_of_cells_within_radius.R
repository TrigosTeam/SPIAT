...
#'
#' @description Calculates the number of cells positive for a target marker
#'   within a pre-defined radius around cells positive for a reference marker

#' @param sce_object SingleCellExperiment object in the form of the output of
#'   format_image_to_sce.
#' @param reference_celltype String. Cell type to be used for reference cells.
#' @param target_marker String. Cell type to be used for target cells.
...
number_of_cells_within_radius <- function (sce_object, reference_marker, 
                                           target_marker, radius = 20, 
                                           feature_colname) 
{
