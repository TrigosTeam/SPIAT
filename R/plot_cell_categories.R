phenotypes_of_interest <- c("AMACR", "CD3,CD4", "CD3,CD8", "PDL1")
colour_vector <- c("darkgrey", "red", "blue", "orange")

#Cells that are not part of the phenotypes of interest are assigned to be "lightgrey"
